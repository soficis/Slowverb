...
/// Central design tokens for the VaporXP Luna aesthetic.
/// These values should be the single source of truth for colors, spacing, and radii.
abstract final class SlowverbTokens {
  ...
  // === SURFACE COLORS ===
  static const Color surfaceBase = Color(0xFF1A1A2E); // Deep blue-purple
  static const Color surfaceCard = Color(0x14FFFFFF); // 8% white overlay
  static const Color surfaceCardHover = Color(0x1FFFFFFF); // 12% white overlay
  static const Color surfaceGlass = Color(0x29FFFFFF); // 16% glassmorphism
  ...
  static const LinearGradient backgroundGradient = LinearGradient(
    ...
    colors: [
      Color(0xFF2B1A3D), // Deep violet top
      Color(0xFF0F1628), // Midnight base
    ],
  );
